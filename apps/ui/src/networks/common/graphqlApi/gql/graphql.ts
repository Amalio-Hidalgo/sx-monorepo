...
export type Proposal = {
  ...
  executed_at: Maybe<Scalars['Int']['output']>;
  /** Block number when the proposal execution was finalized (EVM only) */
  executed_at_block_number: Maybe<Scalars['Int']['output']>;
  ...
  max_end_block_number: Maybe<Scalars['Int']['output']>;
  ...
  min_end_block_number: Maybe<Scalars['Int']['output']>;
...
export type Proposal_Filter = {
  ...
  executed_at?: InputMaybe<Scalars['Int']['input']>;
  executed_at_block_number?: InputMaybe<Scalars['Int']['input']>;
  executed_at_block_number_gt?: InputMaybe<Scalars['Int']['input']>;
  executed_at_block_number_gte?: InputMaybe<Scalars['Int']['input']>;
  executed_at_block_number_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  executed_at_block_number_lt?: InputMaybe<Scalars['Int']['input']>;
  executed_at_block_number_lte?: InputMaybe<Scalars['Int']['input']>;
  executed_at_block_number_not?: InputMaybe<Scalars['Int']['input']>;
  executed_at_block_number_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  executed_at_gt?: InputMaybe<Scalars['Int']['input']>;
  executed_at_gte?: InputMaybe<Scalars['Int']['input']>;
  executed_at_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  executed_at_lt?: InputMaybe<Scalars['Int']['input']>;
  executed_at_lte?: InputMaybe<Scalars['Int']['input']>;
  executed_at_not?: InputMaybe<Scalars['Int']['input']>;
  executed_at_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  ...
  max_end_block_number?: InputMaybe<Scalars['Int']['input']>;
  max_end_block_number_gt?: InputMaybe<Scalars['Int']['input']>;
  max_end_block_number_gte?: InputMaybe<Scalars['Int']['input']>;
  max_end_block_number_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  max_end_block_number_lt?: InputMaybe<Scalars['Int']['input']>;
  max_end_block_number_lte?: InputMaybe<Scalars['Int']['input']>;
  max_end_block_number_not?: InputMaybe<Scalars['Int']['input']>;
  max_end_block_number_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  ...
  min_end_block_number?: InputMaybe<Scalars['Int']['input']>;
  min_end_block_number_gt?: InputMaybe<Scalars['Int']['input']>;
  min_end_block_number_gte?: InputMaybe<Scalars['Int']['input']>;
  min_end_block_number_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  min_end_block_number_lt?: InputMaybe<Scalars['Int']['input']>;
  min_end_block_number_lte?: InputMaybe<Scalars['Int']['input']>;
  min_end_block_number_not?: InputMaybe<Scalars['Int']['input']>;
  min_end_block_number_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
...
export type ScoresTick_OrderBy =
  | '_indexer'
  | 'id'
  | 'proposal'
  | 'scores_1'
...
export type VotesQuery = { votes: Array<{ id: string, proposal: string, choice: number, vp: any, created: number, tx: string, voter: { id: string }, space: { id: string }, metadata: { reason: any } | null }> };
...
export type UserVotesQuery = { votes: Array<{ id: string, proposal: string, choice: number, vp: any, created: number, tx: string, voter: { id: string }, space: { id: string }, metadata: { reason: any } | null }> };
...
export type ProposalScoresTicksQueryVariables = Exact<{
  id: Scalars['String']['input'];
}>;


export type ProposalScoresTicksQuery = { proposal: { scores_ticks: Array<{ timestamp: number, scores_1: any, scores_2: any, scores_3: any }> } | null };
...
export const ProposalScoresTicksDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ProposalScoresTicks"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"proposal"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"scores_ticks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"timestamp"}},{"kind":"Field","name":{"kind":"Name","value":"scores_1"}},{"kind":"Field","name":{"kind":"Name","value":"scores_2"}},{"kind":"Field","name":{"kind":"Name","value":"scores_3"}}]}}]}}]}}]} as unknown as DocumentNode<ProposalScoresTicksQuery, ProposalScoresTicksQueryVariables>;